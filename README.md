...
当前测试版聚焦剧本创作与资料整理：创建作品、整理角色和设定、编写分场剧本、记录素材想法，并在写作过程中把同一场景需要参考的内容放在一起查看。本软件当前测试版允许个人、非商业用途免费使用。
...
```text
OpenGalgame_0.1.0_x64-setup.exe
```

如果是在源码构建产物目录中查看本文件，安装包通常位于：

```text
bundle\nsis\OpenGalgame_0.1.0_x64-setup.exe
```

## 安装

1. 打开 GitHub Releases 页面，下载 `OpenGalgame_0.1.0_x64-setup.exe`。
2. 双击安装包，按安装向导完成安装。
